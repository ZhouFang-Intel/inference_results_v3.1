...
custom_systems['ACC_H100'] = SystemConfiguration(host_cpu_conf=CPUConfiguration(layout={CPU(name="GENUINE INTEL(R) XEON(R)", architecture=CPUArchitecture.x86_64, core_count=72, threads_per_core=2): 2}), host_mem_conf=MemoryConfiguration(host_memory_capacity=Memory(quantity=395.271148, byte_suffix=ByteSuffix.GB), comparison_tolerance=0.05), accelerator_conf=AcceleratorConfiguration(layout={KnownGPU.H100_PCIe_80GB.value: 1}), numa_conf=None, system_id="ACC_H100")
